...
describe('v1.ReservationServiceClient', () => {
    ...
    describe('updateAssignment', () => {
        it('invokes updateAssignment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.reservation.v1.UpdateAssignmentRequest());
            request.assignment = {};
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateAssignment as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('searchAllAssignments', () => {
        it('invokes searchAllAssignments without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.bigquery.reservation.v1.SearchAllAssignmentsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.searchAllAssignments as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
